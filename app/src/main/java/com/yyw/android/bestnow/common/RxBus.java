package com.yyw.android.bestnow.common;
 ...
 * <p>
 * post use {@link #post(Object)}, you should define a specific Object for every type event like {@link com.yangyongwen.android.app.sreminder.cardproviders.reservation.train.ChooseTrainStationEvent}
 * post example {@link com.yangyongwen.android.app.sreminder.cardproviders.reservation.train.StationChooserActivity#mlistView}
 * <p>
 * subscribe use {@link #toObservable(Class)}
 * example {@link com.yangyongwen.android.app.sreminder.cardproviders.reservation.train.TrainCardAgent#rxSubscription}
 * remember {@link Subscription#unsubscribe()} after usage to avoid memory leak. like {@link com.yangyongwen.android.app.sreminder.cardproviders.reservation.train.TrainCardAgent#onDestroy(Context)}
 * <p>
 ...
 *
 * @Override public EventSticky call(EventSticky eventSticky) {
 * try {
 * // operations...
 * } catch (Exception e) {
 * e.printStackTrace();
