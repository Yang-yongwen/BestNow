...
public class PerHourUsageDao extends AbstractDao<PerHourUsage, Long> {
    ...
    public static class Properties {
        ...
        public final static Property LaunchCount = new Property(3, Integer.class, "launchCount", false, "LAUNCH_COUNT");
        public final static Property UsageTime = new Property(4, Long.class, "usageTime", false, "USAGE_TIME");
    }
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PER_HOUR_USAGE\" (" + //
                ...
                "\"TIME\" INTEGER," + // 2: time
                "\"LAUNCH_COUNT\" INTEGER," + // 3: launchCount
                "\"USAGE_TIME\" INTEGER);"); // 4: usageTime
    }
    ...
    protected void bindValues(SQLiteStatement stmt, PerHourUsage entity) {
        ...
        if (launchCount != null) {
            stmt.bindLong(4, launchCount);
        }

        Long usageTime = entity.getUsageTime();
        if (usageTime != null) {
            stmt.bindLong(5, usageTime);
        }
    }
    ...
    public PerHourUsage readEntity(Cursor cursor, int offset) {
        PerHourUsage entity = new PerHourUsage( //
                ...
                cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3), // launchCount
                cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4) // usageTime
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, PerHourUsage entity, int offset) {
        ...
        entity.setLaunchCount(cursor.isNull(offset + 3) ? null : cursor.getInt(offset + 3));
        entity.setUsageTime(cursor.isNull(offset + 4) ? null : cursor.getLong(offset + 4));
    }
