...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        AppUsageDao.createTable(db, ifNotExists);
        PerHourUsageDao.createTable(db, ifNotExists);
    ...
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        AppUsageDao.dropTable(db, ifExists);
        PerHourUsageDao.dropTable(db, ifExists);
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(AppUsageDao.class);
        registerDaoClass(PerHourUsageDao.class);
